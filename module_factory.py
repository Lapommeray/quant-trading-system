...
class AdvancedModuleFactory:
                    ...
                    if file.endswith(".py") and not file.startswith("__"):
                        ...
                        try:
                            ...
                            spec = importlib.util.spec_from_file_location(
                                f"advanced_modules.{category}.{module_name}", file_path
                            )
                            ...
                            for attr_name in dir(module):
                                ...
                                if (
                                    ...
                                    and attr_name != "AdvancedModuleInterface"
                                ):
    ...
    def create_module(
        self, category: str, module_name: str, config: Optional[Dict[str, Any]] = None
    ):
