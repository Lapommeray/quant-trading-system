...
logging.basicConfig(
    ...
    handlers=[logging.FileHandler("mt5_live.log"), logging.StreamHandler()],
)
...
class MT5LiveRunner:
    ...
    def _create_mt5_signal(
        self, symbol: str, final_signal: Optional[str], confidence: float
    ) -> Dict[str, Any]:
        """
    ...
    def _process_symbol(self, symbol: str) -> bool:
        ...
        if success:
            ...
            logger.info(
                f"Signal written for {symbol}: {mt5_signal['signal']} "
