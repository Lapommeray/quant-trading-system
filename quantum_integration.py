...
if __name__ == "__main__":
    ...
    for symbol in symbols:
        ...
        print(
            f"Quantum Signal: {quantum_signal['signal']} (Confidence: {quantum_signal['confidence']:.2f})"
        )
        print(f"Reason: {quantum_signal['reason']}")

        divine_signal = get_divine_signal(symbol)
        print(
            f"Divine Signal: {divine_signal['signal']} (Confidence: {divine_signal['confidence']:.2f})"
        )
