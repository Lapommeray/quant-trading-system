...
class AstroGeoSync:
    ...
    def decode(self, symbol, history_bars):
        ...
        if is_resonant:
            if planetary_resonance["score"] > max(
                seismic_resonance["score"], solar_resonance["score"]
            ):
            ...
            self.algo.Debug(
                f"AstroGeoSync: Significant resonance detected! Score: {combined_score:.2f}, Bias: {market_bias}"
            )
        else:
            market_bias = "NEUTRAL"
