...
class RealTimeDashboard:
        ...
        self.app.layout = dbc.Container(
            [
                dbc.Row(
                    [
                        dbc.Col(
                            html.H1("QMP GOD MODE v8.0", className="text-center mb-4"),
                            width=12,
                        )
                    ]
                ),
                ...
                dbc.Row([dbc.Col(dcc.Graph(id="signal-strength"), width=12)]),
    ...
    def _create_signal_fig(self):
        ...
        fig.update_layout(
            title="Signal Strength Analysis", template="plotly_dark", height=300
        )
        return fig
