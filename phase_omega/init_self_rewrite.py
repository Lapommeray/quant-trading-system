...
class AutonomousRewriter:
    ...
    def set_directive(self, directive):
        ...
        if directive in self.objective_rewriter.DIRECTIVES:
            ...
            print(
                f"Valid directives: {', '.join(self.objective_rewriter.DIRECTIVES.keys())}"
            )
            return False
    ...
    def rewrite(self, market_data=None):
        ...
        if should_rewrite:
            ...
            results = {
                ...
                "description": self.objective_rewriter.DIRECTIVES[
                    self.objective_rewriter.current_directive
                ],
