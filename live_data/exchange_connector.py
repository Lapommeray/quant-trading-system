...
class ExchangeConnector:
    ...
    def test_connection(self) -> bool:
        ...
        try:
            ...
            logger.info(
                f"🟢 LIVE DATA: {self.exchange_id} connected, BTC/USDT price: {ticker['last']}"
            )
            return True
    ...
    def fetch_ticker(self, symbol: str) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.error(
                f"Error fetching ticker for {symbol} from {self.exchange_id}: {e}"
            )
            return {}
    ...
    def fetch_ohlcv(
        ...
        try:
            ...
            logger.error(
                f"Error fetching OHLCV for {symbol} from {self.exchange_id}: {e}"
            )
            return []
    ...
    def fetch_order_book(
        ...
        try:
            ...
            logger.error(
                f"Error fetching order book for {symbol} from {self.exchange_id}: {e}"
            )
            return {}
    ...
    def fetch_trades(
        ...
        try:
            ...
            logger.error(
                f"Error fetching trades for {symbol} from {self.exchange_id}: {e}"
            )
            return []
    ...
    def create_order(
        ...
        try:
            ...
            logger.error(
                f"Error creating {order_type} {side} order for {symbol} on {self.exchange_id}: {e}"
            )
            return {}
    ...
    def cancel_order(
        ...
        try:
            ...
            logger.error(
                f"Error cancelling order {order_id} on {self.exchange_id}: {e}"
            )
            return {}
