...
def is_macro_environment_favorable(thresholds=None):
    ...
    checks = [
        ...
        snapshot["Fed_Funds_Rate"] is not None
        and snapshot["Fed_Funds_Rate"] < thresholds["Fed_Funds_Rate"],
        snapshot["Unemployment"] is not None
        and snapshot["Unemployment"] < thresholds["Unemployment"],
    ]
