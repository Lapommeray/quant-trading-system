...
logging.basicConfig(
    ...
    handlers=[logging.FileHandler("apex_autonomy.log"), logging.StreamHandler()],
)
...
def main():
    ...
    parser.add_argument(
        "--skip-validation", action="store_true", help="Skip initial validation cycle"
    )
