...
class ProfitCalculator:
    ...
    def __init__(self, algorithm):
        ...
        self.sl_settings = {
            "default": {"levels": [0.382, 0.5, 0.618], "weights": [0.3, 0.4, 0.3]},
            "aggressive": {"levels": [0.5, 0.618, 0.786], "weights": [0.2, 0.3, 0.5]},
            "conservative": {"levels": [0.236, 0.382, 0.5], "weights": [0.4, 0.4, 0.2]},
        }

        self.trade_data = {}

    def calculate_targets(
        self, symbol, entry_price, direction, volatility=None, profile="default"
    ):
        """
        ...
        for level in tp_levels:
            ...
            tp_targets.append({"level": level, "price": price})
        ...
        for level in sl_levels:
            ...
            sl_targets.append({"level": level, "price": price})
        ...
        self.trade_data[trade_id] = {
            ...
            "risk_reward": (
                abs(weighted_tp - entry_price) / abs(weighted_sl - entry_price)
                if abs(weighted_sl - entry_price) > 0
                else 0.0
            ),
        }
