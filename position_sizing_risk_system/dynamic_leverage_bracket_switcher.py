...
class DynamicLeverageBracketSwitcher:
    ...
    def __init__(self, algorithm):
        ...
        self.risk_data = {"vix": 0.0, "drawdown": 0.0, "market_stress": 0.0}
    ...
    def update(self, current_time, conviction_data=None, risk_data=None):
        ...
        if (
            ...
            and conviction_data is None
            and risk_data is None
        ):
            return {
    ...
    def _update_conviction_data(self, conviction_data):
        ...
        """
        self.conviction_data["signal_strength"] = conviction_data.get(
            "signal_strength", self.conviction_data["signal_strength"]
        )
        self.conviction_data["signal_consistency"] = conviction_data.get(
            "signal_consistency", self.conviction_data["signal_consistency"]
        )
        self.conviction_data["signal_confirmation"] = conviction_data.get(
            "signal_confirmation", self.conviction_data["signal_confirmation"]
        )
    ...
    def _update_risk_data(self, risk_data):
        ...
        self.risk_data["drawdown"] = risk_data.get(
            "drawdown", self.risk_data["drawdown"]
        )
        self.risk_data["market_stress"] = risk_data.get(
            "market_stress", self.risk_data["market_stress"]
        )
