...
class MetaConsciousRouter:
    ...
    def route_signal(self, market_state):
        ...
        volume_ratio = (
            market_state["volume"] / np.mean(self.volume_history)
        ...
        if emotion_score < -0.8 and volatility > 0.05:
            return {
                ...
                "parameters": {"aggression": 0.9, "timeframe": "1m"},
            }
        elif emotion_score > 0.7 and volume_ratio > 1.5:
            return {
                "system": "SPIRIT_OVERRIDE",
                "confidence": emotion_score * volume_ratio,
                "parameters": {"mode": "hyper_bull", "timeframe": "5m"},
            }
        else:
            return {
                "system": "QMP_CORE",
                "confidence": 0.85,
                "parameters": {"mode": "standard", "timeframe": "15m"},
            }
