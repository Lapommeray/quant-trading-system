...
from modules.energy_filter import (
    is_global_shock_active,
    is_cosmic_energy_disturbed,
    is_today_a_sacred_entry_day,
)
...
class QMPOverrider:
    ...
    def generate_signal(self, timestamp):
        ...
        is_bullish = (
            big_move["big_buy_imminent"]
            or timelines["bullish_timeline_dominance"]
            > timelines["bearish_timeline_dominance"]
        )
