    ...
    def ascend(
        ...
        return {
            ...
            "dark_pool_possessor": {
                ...
                "status": (
                    self.dark_pool_possessor.status
                    if self.dark_pool_possessor
                    else "INACTIVE"
                ),
            },
            "fed_echo_listener": {
                ...
                "status": (
                    self.fed_echo_listener.status
                    if self.fed_echo_listener
                    else "INACTIVE"
                ),
            },
            "singularity_router": {
                ...
                "status": (
                    self.singularity_router.status
                    if self.singularity_router
                    else "INACTIVE"
                ),
            },
