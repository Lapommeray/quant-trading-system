...
logging.basicConfig(
    ...
    handlers=[logging.FileHandler("mirror_ai.log"), logging.StreamHandler()],
)
...
class MirrorAI:
    ...
    def analyze_market(
        self, data: Dict, aggressor_signal: Optional[Dict] = None
    ) -> Dict:
        ...
        logger.info(
            f"Generated defense signal: {defense_strategy['defense_signal']} with confidence {defense_strategy['confidence']}"
        )
