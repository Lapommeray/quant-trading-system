...
class TestReadSignal(unittest.TestCase):
    ...
    def setUp(self):
        """Set up test fixtures"""
        self.test_dir = tempfile.mkdtemp()
        init_bridge({"mt5_signal_dir": self.test_dir, "mt5_signal_interval_seconds": 0})
...
class TestJsonSerialization(unittest.TestCase):
    ...
    def test_serialize_nested_dict(self):
        ...
        data = {"outer": {"inner": datetime(2024, 1, 15), "value": 42}}
...
class TestBridgeAvailability(unittest.TestCase):
    ...
    def test_bridge_disabled(self):
        ...
        init_bridge({"mt5_signal_dir": self.test_dir, "mt5_bridge_enabled": False})
...
class TestBackwardCompatibility(unittest.TestCase):
    ...
    def test_disabled_bridge_write_returns_false(self):
        ...
        try:
            init_bridge({"mt5_signal_dir": test_dir, "mt5_bridge_enabled": False})
