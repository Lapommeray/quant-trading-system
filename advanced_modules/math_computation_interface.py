...
class MathComputationInterface:
    ...
    def __init__(
        self,
        precision: int = 64,
        use_mathematica: bool = False,
        use_matlab: bool = False,
        mathematica_path: Optional[str] = None,
        ...
        self.mathematica_available = (
            self._check_mathematica() if use_mathematica else False
        )
    ...
    def solve_equation_sympy(self, equation_str: str, variable_str: str = "x") -> List:
        ...
        try:
            ...
            result = [
                float(sol) if sp.im(sol) == 0 else complex(sol) for sol in solutions
            ]
    ...
    def symbolic_differentiate(
        self, expression_str: str, variable_str: str = "x", order: int = 1
    ) -> str:
        """
        ...
        try:
            ...
            if lower_bound is not None and upper_bound is not None:
                integral = sp.integrate(
                    expression, (variable, lower_bound, upper_bound)
                )
            else:
