...
class SpoofingDetector:
    ...
    def detect(self, symbol, history_data):
        ...
        spoofing_detected = (
            flowalgo_score > self.cluster_threshold
        ...
        if spoofing_detected:
            self.algo.Debug(
                f"SpoofingDetector: Potential spoofing detected for {symbol}! "
        ...
        return {
            ...
            "confidence": confidence,
            "direction": (
                "SELL" if spoofing_detected else None
            ),  # Spoofing usually indicates a reversal
        }
    ...
    def get_recent_patterns(self):
        ...
        frequent_spoofing = (
            spoofing_count >= 3
        )  # 30% or more of recent bars show spoofing
