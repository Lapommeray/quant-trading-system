...
class RLRewardTracker:
    ...
    def __init__(
        ...
        logger.info(
            f"RLRewardTracker initialized: λ_ig={lambda_ig}, λ_risk={lambda_risk}"
        )
    ...
    def record_step(
        ...
        raw_reward = (
            pnl_delta + self.lambda_ig * realized_ig - self.lambda_risk * drawdown
        )
    ...
    def update_lambdas(
        self, lambda_ig: Optional[float] = None, lambda_risk: Optional[float] = None
    ):
