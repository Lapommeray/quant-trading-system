...
def black_litterman_optimization(
    ...
    if P is None or Q is None:
        ...
        return optimizer.optimize_with_views(
            market_weights, cov_matrix, P, Q, constraints
        )
...
class BlackLittermanOptimizer:
    ...
    def incorporate_views(self, prior_returns, cov_matrix, P, Q, omega=None):
        ...
        try:
            ...
            posterior_precision = prior_precision + np.dot(
                np.dot(P.T, omega_precision), P
            )
        ...
        try:
            ...
            if "target_return" in constraints:
                constraints_list.append(
                    portfolio_return >= constraints["target_return"]
                )
            ...
            if problem.status == "optimal":
                ...
                result = {
                    ...
                    "sharpe_ratio": (
                        float(portfolio_return.value / np.sqrt(portfolio_risk.value))
    ...
    def optimize_with_views(self, market_weights, cov_matrix, P, Q, constraints=None):
        ...
        try:
            ...
            posterior_returns = self.incorporate_views(
                implied_returns, cov_matrix, P, Q
            )

            optimal_weights = self.optimize_portfolio(
                posterior_returns, cov_matrix, constraints
            )
